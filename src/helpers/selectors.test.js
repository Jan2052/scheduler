...
test('3. getInterviewersForDay returns an array', () => {
  const result = getInterviewersForDay(state, 'Monday');
  expect(Array.isArray(result)).toBe(true);
});

test('3. getInterviewersForDay returns an array with a length matching the number of appointments for that day', () => {
  const result = getInterviewersForDay(state, 'Monday');
...
test('3. getInterviewersForDay returns an empty array when the days data is empty', () => {
  const result = getInterviewersForDay({days: []}, 'Monday');
  expect(result.length).toEqual(0);
});

test('3. getInterviewersForDay returns an empty array when the day is not found', () => {
